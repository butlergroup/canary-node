...
* \[[`6bfbc7d763`](https://github.com/nodejs/node/commit/6bfbc7d763)] - **(SEMVER-MAJOR)** **build**: bump GCC requirement to 13.2 (Michaël Zasso) [#62555](https://github.com/nodejs/node/pull/62555)
* \[[`21d3e722be`](https://github.com/nodejs/node/commit/21d3e722be)] - **(SEMVER-MAJOR)** **build**: enable Temporal by default (Richard Lau) [#61806](https://github.com/nodejs/node/pull/61806)
...
* \[[`cda41d669b`](https://github.com/nodejs/node/commit/cda41d669b)] - **(SEMVER-MAJOR)** **build,win**: fix Temporal build (StefanStojanovic) [#61806](https://github.com/nodejs/node/pull/61806)
...
* \[[`76be660441`](https://github.com/nodejs/node/commit/76be660441)] - **(SEMVER-MAJOR)** **test**: skip wasm allocation tests in workers (Michaël Zasso) [#61898](https://github.com/nodejs/node/pull/61898)
...
* \[[`3fb47edc5d`](https://github.com/nodejs/node/commit/3fb47edc5d)] - **build**: use `CARGO` environment variable if set (Richard Lau) [#62421](https://github.com/nodejs/node/pull/62421)
* \[[`462c035034`](https://github.com/nodejs/node/commit/462c035034)] - **build**: add weak symbol detection to export script (Abdirahim Musse) [#62656](https://github.com/nodejs/node/pull/62656)
* \[[`66db81a595`](https://github.com/nodejs/node/commit/66db81a595)] - **build**: filter hidden visibility symbols on AIX (Abdirahim Musse) [#62656](https://github.com/nodejs/node/pull/62656)
* \[[`0bb78a47c0`](https://github.com/nodejs/node/commit/0bb78a47c0)] - **build**: aix add conditonal flags for clang builds (Abdirahim Musse) [#62656](https://github.com/nodejs/node/pull/62656)
...
* \[[`9c40dc8cd2`](https://github.com/nodejs/node/commit/9c40dc8cd2)] - **deps**: V8: cherry-pick fcf8b990c73c (Abdirahim Musse) [#62894](https://github.com/nodejs/node/pull/62894)
* \[[`6ad154ccf7`](https://github.com/nodejs/node/commit/6ad154ccf7)] - _**Revert**_ "**deps**: V8: cherry-pick 7107287" (Richard Lau) [#62894](https://github.com/nodejs/node/pull/62894)
* \[[`fc1b279e62`](https://github.com/nodejs/node/commit/fc1b279e62)] - **deps**: V8: cherry-pick 7107287 (Abdirahim Musse) [#62656](https://github.com/nodejs/node/pull/62656)
* \[[`b0f08e5395`](https://github.com/nodejs/node/commit/b0f08e5395)] - **deps**: fix aix implicit declaration in OpenSSL (Abdirahim Musse) [#62656](https://github.com/nodejs/node/pull/62656)
...
* \[[`247eb7dc2e`](https://github.com/nodejs/node/commit/247eb7dc2e)] - **src**: do not enable wasm trap handler if there's not enough vmem (Joyee Cheung) [#62132](https://github.com/nodejs/node/pull/62132)
* \[[`3302828fcf`](https://github.com/nodejs/node/commit/3302828fcf)] - **src**: workaround AIX libc++ std::filesystem bug (Richard Lau) [#62788](https://github.com/nodejs/node/pull/62788)
